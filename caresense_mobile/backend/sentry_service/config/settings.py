...
# caresense_mobile copy: BASE_PROJECT_DIR resolves to caresense_mobile/
# MODELS_DIR is overridden via .env to point to the trained model files.
BACKEND_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # sentry_service/
PROCESSED_DATA_DIR = os.path.join(BACKEND_DIR, "data", "processed")
MODELS_DIR = os.getenv(
    "MODELS_DIR",
    os.path.join(BACKEND_DIR, "models", "saved")  # fallback: place models here
)
